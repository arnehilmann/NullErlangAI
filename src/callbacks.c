...
int handle_command(int skirmishAIId, const struct SSkirmishAICallback* callback, char* command, char* recvbuff, int index){
        ...
        if (strcmp(command, "fetch_getWeaponDefByName") == 0) {
        char* weaponDefName;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_getWeaponDefByName");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Game_getCategoriesFlag") == 0) {
        char* categoryNames;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Game_getCategoriesFlag");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_DataDirs_getPathSeparator") == 0) {
        char result = callback->DataDirs_getPathSeparator(skirmishAIId);
        ei_x_buff sendbuff;
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_DataDirs_getPathSeparator");
        ...
        if (strcmp(command, "fetch_getFriendlyUnitsIn") == 0) {
        float pos_posF3[3];
        double tmp;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_getFriendlyUnitsIn");
        ei_x_encode_list_header(&sendbuff, result);
        int i = 0;
        for (; i < result; i++) {
            ei_x_encode_long(&sendbuff, unitIds[i]);
        ...
        if (strcmp(command, "fetch_DataDirs_Roots_getDir") == 0) {
        char* path;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_DataDirs_Roots_getDir");
        ei_x_encode_boolean(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_DataDirs_Roots_locatePath") == 0) {
        char* path;
        ei_decode_string(recvbuff, &index, path);
        long path_sizeMax;
        ei_decode_long(recvbuff, &index, &path_sizeMax);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_DataDirs_Roots_locatePath");
        ei_x_encode_boolean(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Map_getElevationAt") == 0) {
        double x;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Map_getElevationAt");
        ei_x_encode_double(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_SkirmishAI_Info_getValueByKey") == 0) {
        char* key;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_SkirmishAI_Info_getValueByKey");
        ei_x_encode_string(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Unit_CurrentCommand_getOptions") == 0) {
        long unitId;
        ei_decode_long(recvbuff, &index, &unitId);
        long commandId;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Unit_CurrentCommand_getOptions");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Map_getResourceMapSpotsPositions") == 0) {
        long resourceId;
        ei_decode_long(recvbuff, &index, &resourceId);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Map_getResourceMapSpotsPositions");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Unit_getUnitRulesParamByName") == 0) {
        long unitId;
        ei_decode_long(recvbuff, &index, &unitId);
        char* rulesParamName;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Unit_getUnitRulesParamByName");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_DataDirs_locatePath") == 0) {
        char* path;
        ei_decode_string(recvbuff, &index, path);
        long path_sizeMax;
        ei_decode_long(recvbuff, &index, &path_sizeMax);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_DataDirs_locatePath");
        ei_x_encode_boolean(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Group_OrderPreview_getOptions") == 0) {
        long groupId;
        ei_decode_long(recvbuff, &index, &groupId);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Group_OrderPreview_getOptions");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Cheats_setEnabled") == 0) {
        int enable;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Cheats_setEnabled");
        ei_x_encode_boolean(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_SkirmishAI_OptionValues_getValueByKey") == 0) {
        char* key;
        ei_decode_string(recvbuff, &index, key);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_SkirmishAI_OptionValues_getValueByKey");
        ei_x_encode_string(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Cheats_setEventsEnabled") == 0) {
        int enabled;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Cheats_setEventsEnabled");
        ei_x_encode_boolean(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Team_getTeamRulesParamByName") == 0) {
        long teamId;
        ei_decode_long(recvbuff, &index, &teamId);
        char* rulesParamName;
        ei_decode_string(recvbuff, &index, rulesParamName);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Team_getTeamRulesParamByName");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_UnitDef_MoveData_getDepthMod") == 0) {
        long unitDefId;
        ei_decode_long(recvbuff, &index, &unitDefId);
        double height;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_UnitDef_MoveData_getDepthMod");
        ei_x_encode_double(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_File_getSize") == 0) {
        char* fileName;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_File_getSize");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Map_getPoints") == 0) {
        int includeAllies;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Map_getPoints");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_getNeutralUnitsIn") == 0) {
        float pos_posF3[3];
        double tmp;
        ei_decode_double(recvbuff, &index, &tmp);
        pos_posF3[0] = tmp;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_getNeutralUnitsIn");
        ei_x_encode_list_header(&sendbuff, result);
        int i = 0;
        for (; i < result; i++) {
            ei_x_encode_long(&sendbuff, unitIds[i]);
        ...
        if (strcmp(command, "fetch_UnitDef_MoveData_getMaxTurnRate") == 0) {
        long unitDefId;
        ei_decode_long(recvbuff, &index, &unitDefId);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_UnitDef_MoveData_getMaxTurnRate");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_getUnitDefByName") == 0) {
        char* unitName;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_getUnitDefByName");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Game_getGameRulesParamByName") == 0) {
        char* rulesParamName;
        ei_decode_string(recvbuff, &index, rulesParamName);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Game_getGameRulesParamByName");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Game_getCategoryFlag") == 0) {
        char* categoryName;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Game_getCategoryFlag");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_getEnemyUnitsIn") == 0) {
        float pos_posF3[3];
        double tmp;
        ei_decode_double(recvbuff, &index, &tmp);
        pos_posF3[0] = tmp;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_getEnemyUnitsIn");
        ei_x_encode_list_header(&sendbuff, result);
        int i = 0;
        for (; i < result; i++) {
            ei_x_encode_long(&sendbuff, unitIds[i]);
        ...
        if (strcmp(command, "fetch_Map_isPosInCamera") == 0) {
        float pos_posF3[3];
        double tmp;
        ei_decode_double(recvbuff, &index, &tmp);
        pos_posF3[0] = tmp;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Map_isPosInCamera");
        ei_x_encode_boolean(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_getResourceByName") == 0) {
        char* resourceName;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_getResourceByName");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Map_getLines") == 0) {
        int includeAllies;
        ei_decode_boolean(recvbuff, &index, &includeAllies);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Map_getLines");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_Map_isPossibleToBuildAt") == 0) {
        long unitDefId;
        ei_decode_long(recvbuff, &index, &unitDefId);
        float pos_posF3[3];
        double tmp;
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_Map_isPossibleToBuildAt");
        ei_x_encode_boolean(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
        ...
        if (strcmp(command, "fetch_WeaponDef_Shield_getAlpha") == 0) {
        long weaponDefId;
        ei_decode_long(recvbuff, &index, &weaponDefId);
        ...
        ei_x_new_with_version(&sendbuff);
        ei_x_encode_tuple_header(&sendbuff, 2);
        ei_x_encode_atom(&sendbuff, "result_WeaponDef_Shield_getAlpha");
        ei_x_encode_long(&sendbuff, result);
        return send_to_hq(skirmishAIId, sendbuff);
    }
